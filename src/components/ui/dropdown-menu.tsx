...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "flex w-full cursor-default items-center gap-2 rounded-sm px-3 py-2 text-left outline-hidden select-none focus:bg-black/10 dark:focus:bg-white/10 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className
      )}
      {...props}
    />
