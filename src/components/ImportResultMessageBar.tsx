...
export function ImportResultMessageBar({ importedCount, skipped, onDismiss }: ImportResultMessageBarProps) {
  ...
  return (
    <div className="mx-2 mt-2 flex flex-col gap-2 rounded-md border border-surface-border bg-surface px-4 py-2">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          type="button"
          onClick={onDismiss}
          className="ml-auto text-sm text-app-foreground underline opacity-60 hover:opacity-100"
